...
def test_administrador_cadastra_programa(cliente, usuarios):
    r = cliente.post(
        f"{PREFIXO}/programas", json=CORPO_PROGRAMA,
...
def test_papel_sem_permissao_recebe_403(cliente, usuarios, email):
    r = cliente.post(
        f"{PREFIXO}/programas", json=CORPO_PROGRAMA,
