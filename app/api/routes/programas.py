"""Cadastro de programas — o exemplo pedido de rota restrita a um papel.

Serve de molde para todas as rotas dos próximos sprints: a permissão fica
na assinatura da função, não em `if` dentro do corpo.
"""
...
def cadastrar_programa(
    ...
    admin: SomenteAdministrador,  # <- é isso que barra os outros papéis
...
def listar_programas(
    usuario: UsuarioAtual,  # qualquer papel autenticado pode ler
    db: Annotated[Session, Depends(get_db)],
